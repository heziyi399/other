package com.hzyexample.other.aop;


import com.hzyexample.other.annotation.Cache;
import com.hzyexample.other.annotation.CacheEvictor;
import com.hzyexample.other.aop.processor.AbstractCacheAnnotationProcessor;
import com.hzyexample.other.aop.processor.CacheEvictorAnnotationProcessor;
import com.hzyexample.other.aop.processor.CachesAnnotationProcessor;
...
public class CacheMethodInterceptor implements Interceptor{
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.hzyexample.other.annotation.Cache)")//环绕通知
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.hzyexample.other.annotation.CacheEvictor)")//环绕通知
